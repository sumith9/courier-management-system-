...
<style>
    body {
        background-image: url('../images/plain-colour-03.jpg');
        background-size: cover;
        }
</style>
<div class="admintitle">
    <div>
    <h3 ><a href="dashboard.php" style="float: left; margin-left:20px; color:aliceblue;">BackToDashboard</a></h3>
    <h3 ><a href="logout.php" style="float: right; margin-right:20px; color:aliceblue;">LogOut</a></h3>
    </div>
...
<table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-collapse: collapse;">
    <tr style="background-color: #055C9D;">
        <th>No.</th>
        <th>Users Name</th>
        <th>Email Id</th>
        <th>Action</th>
